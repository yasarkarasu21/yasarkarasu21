...
### 🚀 Hakkımda
- 🔭 ERP sistemleri geliştirme ve uyarlama üzerine çalışıyorum  
- 🌱 C#, .NET, SQL Server ve VBA teknolojileri ile iş süreçlerini dijitalleştiriyorum  
- 👯 İş zekâsı (BI) ve raporlama çözümlerinde deneyimliyim  
- ⚡ Amacım: işletmelerin süreçlerini daha verimli, entegre ve yönetilebilir hale getirmek  


### 🛠️ Kullandığım Teknolojiler
![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white&logoWidth=20)
![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white&logoWidth=20)
![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=c-sharp&logoColor=white&logoWidth=20)
